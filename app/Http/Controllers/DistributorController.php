...
class DistributorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('distributor.index')->with('error', 'Mohon maaf, nama distributor sudah ada');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('distributor.index')->with('error', 'Mohon maaf, nama distributor sudah digunakan');
    }
